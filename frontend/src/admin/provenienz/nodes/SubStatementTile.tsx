...
export function SubStatementTile({
  ...
  return (
    <div className="prov-tile border-fuchsia-500 px-3 py-2 w-72">
      <Handle type="target" position={Position.Top} className="opacity-0" />
      <header className="flex items-center gap-1.5 text-[10px] uppercase tracking-wide text-fuchsia-800">
        <Sigma className="w-3 h-3" aria-hidden /> Sub-Aussage
      </header>
      <p className="text-[12px] text-ink mt-1 line-clamp-3 italic">
        „{text}"
      </p>
