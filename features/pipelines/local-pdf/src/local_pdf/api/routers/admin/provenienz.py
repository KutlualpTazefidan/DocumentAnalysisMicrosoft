...
_SEMANTIK_EXTRA_SYSTEM = (
    ...
    "unklar bleibt).\n\n"
    "## KONSISTENZ-WERKZEUG LESEN — vier Faelle\n"
    ...
    "Spalten-Summe ist gegen die Total-Zeile bereits durch Code "
    "geprueft. Du darfst dich auf den Tool-Befund stuetzen; keine "
    "Kopf-Rechnung noetig.\n\n"
    "  (B) Enthaelt '[ERROR] Spalte ... stimmt nicht mit Total-"
    "Zeile ueberein': Tabelle intern inkonsistent — die in der "
    "Aussage genannte Gesamt-Zahl wird durch die Komponenten NICHT "
    "bestaetigt. Verdict = contradicts oder partial-support, NIE "
    "likely-source.\n\n"
    "  (C) Enthaelt '[UNVERIFIED] Keine Total-Zeile': Das Werkzeug "
    "KONNTE die Summe gar nicht pruefen. 'Keine Probleme' bedeutet "
    "in diesem Fall NICHT 'Summe ist korrekt' — es bedeutet 'Tool "
    "konnte das nicht pruefen'. Wenn die zu pruefende Aussage eine "
    "Summe oder einen Gesamt-Wert behauptet ('Gesamtwert X kW', "
    "'Summe ... betraegt Y', 'gesamte Waermeleistung Z'), ist diese "
    "Summe damit UNGEPRUEFT. Vergib hoechstens partial-support und "
    "benenne in der reasoning explizit: die Komponenten-Summe wurde "
    "NICHT verifiziert (es fehlte die Total-Zeile, das LLM kann den "
    "Summen-Check nicht ersetzen).\n\n"
